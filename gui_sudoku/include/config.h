...
#define COLOR_PEER_FILL  RGB(233, 240, 247)
#define COLOR_MATCH_FILL RGB(176, 208, 240)
...
#define COLOR_SOLVED_TEXT RGB(24, 112, 46)
#define COLOR_SOLVED_BORDER RGB(120, 176, 128)
#define COLOR_SOLVED_HINT RGB(96, 108, 96)
